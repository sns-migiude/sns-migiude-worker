  ...
  <div class="main">
    ...
    <div class="body">
      ...
      <section id="s-invite" class="screen hidden">
        ...
        <div class="card">
          <b>招待された人の始め方（リンクを開くと案内が表示されます）</b>
...
<script>
  ...
  function renderInvite(b){
    ...
    if(refurl){
      h+="<label style='margin-top:0'>紹介リンク（これを相手に送ってください）</label>"+
    ...
    h+=(none?"<div class='note' style='margin-top:10px;color:var(--text)'>招待枠を使い切りました。もっと招待したい場合は運営にご相談ください。</div>":"")+
    "</div>";
    C.innerHTML=h;
  }
    ...
    api("GET","/api/account/usage?account="+ACC+q).then(function(r){
      ...
      if ($("usageAssume")){
        ...
        $("usageAssume").innerHTML =
          ...
          + "・AI は<b>モデル別に実トークンで計算</b>（雑務はHaiku＝安い／本生成はSonnet 5）：<br>"+ml+"<br>"
